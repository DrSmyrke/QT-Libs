...
namespace mf {
	...
	QString getSize(const uint32_t val)
	{
		...
		if(val >= 1024 && val < 1024000) str = QString::number(val/1024).left(5) + " Kb";
		if(val >= 1024000 && val < 1024000000) str =  QString::number(val/1048576).left(5) + " Mb";
		if(val >= 1048576000) str =  QString::number(val/1073741824).left(5) + " Gb";
		return str;
	}
